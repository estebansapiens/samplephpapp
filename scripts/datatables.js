 ...
 *   https://datatables.net/download/#bs/jqc-1.11.3,dt-1.10.10,b-1.1.0,b-colvis-1.1.0,cr-1.3.0,fh-3.1.0,r-2.0.0,sc-1.4.0
 *
 * Included libraries:
 *   jQuery compat 1.11.3, DataTables 1.10.10, Buttons 1.1.0, Column visibility 1.1.0, ColReorder 1.3.0, FixedHeader 3.1.0, Responsive 2.0.0, Scroller 1.4.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs/jqc-1.11.3,dt-1.10.10,b-1.1.0,b-colvis-1.1.0,cr-1.3.0,fh-3.1.0,r-2.0.0,sc-1.4.0",
