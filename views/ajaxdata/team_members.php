...
while ( $aRow = mysqli_fetch_array( $rResult ) ) {
    ...
    // Format Specifics
    $row['actions'] = "
    <button special-action='//".$GLOBALS['maincontrol']->adminDirectory."forms/team_members/update.php?entity_id=".$row['ID']."' title='Editar...' class='btn btn-success btn-xs editbtn'><i class='fa fa-pencil-square-o'></i></button>
	||
	...
	$row = array(
		...
		$row['Puesto'],
		$row['Orden'],
		$row['Nivel de Maquillaje'], 
		$row['Nivel de Manicura'],
		$row['actions']
	);
